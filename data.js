// ═══════════════════════════════════════════════════════════════
// Mr. Ali Mahrous — English Language Platform — Data
// ═══════════════════════════════════════════════════════════════

const SITE_CONFIG = {
    name: 'Mr. Ali Mahrous',
    fullName: 'Mr. Ali Mahrous — English Language',
    subtitle: 'English Language Teacher',
    description: 'The premier educational platform for the English Language with Mr. Ali Mahrous — simplified explanations, interactive exercises, and comprehensive exams for all grade levels.',
...
const FEATURES_DATA = [
    {
        ...
        description: 'Step-by-step explanations from the fundamentals, clarifying grammar and language concepts with practical examples — no blind memorisation.',
        colorClass: 'green'
    },
    {
        icon: '📚',
        title: 'Full Coverage of the School Curriculum',
    ...
    },
    {
        ...
        description: 'Simulated end-of-year exams with instant grading and a model answer that explains every correct response in detail.',
        colorClass: 'blue'
    },
    {
        icon: '📄',
...
const STAGES_DATA = [
    {
        ...
        subtitle: 'English Language Track',
        ...
        tags: ['Grammar', 'Reading Comprehension', 'Writing Skills', 'Vocabulary Building']
    },
    {
        id: 'stage-2sec',
        ...
        icon: '📊',
        description: 'Detailed explanation of grammar, essay writing, comprehension, and applied vocabulary.',
        tags: ['Grammar Structures', 'Essay Writing', 'Comprehension', 'Vocabulary']
    },
    {
        id: 'stage-1sec',
        ...
        gradeTag: 'أولى ثانوي',
        icon: '📖',
        description: 'Solid foundation for secondary school English in grammar, reading, writing, and speaking.',
        tags: ['Grammar Foundations', 'Reading Skills', 'Writing Basics', 'Everyday Vocabulary']
    },
    {
        id: 'stage-1prep',
        ...
        icon: '🔤',
        description: 'The start of excellence in preparatory stage — core grammar, spelling, and simple conversation.',
        tags: ['Core Grammar', 'Spelling & Phonics', 'Simple Conversation', 'Basic Vocabulary']
    },
    {
        id: 'stage-2prep',
        ...
        icon: '📊',
        description: 'Strong foundation in tenses, sentence structure, comprehension passages, and letter writing.',
        tags: ['Tenses', 'Sentence Structure', 'Comprehension', 'Letter Writing']
    },
    {
        id: 'stage-3prep',
        ...
        tags: ['Grammar & Structure', 'Reading Passages', 'Functions & Vocabulary', 'Exercises']
    },
    {
        id: 'stage-free',
        ...
        tags: ['Grammar Basics', 'Vocabulary Basics', 'Simple Sentences', 'Platform Gift']
    }
];
...
const FAQ_DATA = [
    ...
    },
    {
        ...
        a: 'The activation code is a unique code used to unlock a paid course on the platform for life. You can obtain it from Mr. Ali Mahrous\'s centre or by contacting the technical support team directly via WhatsApp.'
    },
    {
    ...
    },
    {
        ...
        a: 'Yes. Mr. Ali Mahrous\'s platform is designed to run smoothly and responsively on all devices: smartphones, tablets, laptops, and desktop computers.'
    },
    {
        q: 'How can I contact Mr. Ali Mahrous to ask questions and follow up on assignments?',
...
const ACTIVITY_DATA = [
    ...
    { icon: '🎥', text: 'Watched lesson "Reading Comprehension Skills"', time: 'Yesterday', color: 'blue' },
