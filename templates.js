                ...
                <div class="auth-visual-content">
                    <div class="auth-teacher-badge">
                        ...
                        <div class="auth-t-info">
                            ...
                            <div class="auth-t-sub">Senior English Language Teacher 📖</div>
                        </div>
                    </div>
                    <h2 class="auth-visual-title">Welcome Back to English Excellence! 📖</h2>
                    <p class="auth-visual-desc">Sign in to continue your journey toward the full mark with Mr. Ali Mahrous.</p>
