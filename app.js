// ═══════════════════════════════════════════════════════════════
// منصة الأستاذ علي محروس — Main Application
...
(function () {
                        ...
                        <svg class="header-logo-svg" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <defs>
                                <linearGradient id="amLogoBg" x1="0%" y1="0%" x2="100%" y2="100%">
                                    <stop offset="0%" stop-color="#164E9E"/>
                                    <stop offset="55%" stop-color="#0D2D5C"/>
                                    <stop offset="100%" stop-color="#091F40"/>
                                </linearGradient>
                                <linearGradient id="amLogoRing" x1="0%" y1="0%" x2="100%" y2="100%">
                                    <stop offset="0%" stop-color="#3E86DE"/>
                                    <stop offset="55%" stop-color="#74AEEC"/>
                                ...
                                <linearGradient id="amLogoText" x1="0%" y1="0%" x2="100%" y2="100%">
                                    ...
                                    <stop offset="100%" stop-color="#FFD53D"/>
                                </linearGradient>
                                <filter id="amLogoGlow" x="-20%" y="-20%" width="140%" height="140%">
                                    <feDropShadow dx="0" dy="1.5" stdDeviation="2" flood-color="#F5B400" flood-opacity="0.35"/>
                                </filter>
                            </defs>
                            <circle cx="24" cy="24" r="21" fill="url(#amLogoBg)"/>
                            <circle cx="24" cy="24" r="19.5" stroke="url(#amLogoRing)" stroke-width="1.6" opacity="0.9"/>
                            <circle cx="39" cy="12" r="2.3" fill="#FFD53D" filter="url(#amLogoGlow)"/>
                            <text x="24" y="31" text-anchor="middle" style="font-family:'Inter',sans-serif;font-size:17px;font-weight:800;fill:url(#amLogoText);letter-spacing:0.2px;">AM</text>
                        </svg>
                    </div>
                    <div>
        ...
        <div class="mobile-menu ${mobileMenuOpen ? 'show' : ''}" id="mobileMenu">
            <div class="mobile-menu-header">
                <a href="#home" class="header-logo" onclick="closeMobileMenu()">
                    <div class="header-logo-icon">
                        <svg class="header-logo-svg" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <ellipse cx="24" cy="24" rx="20" ry="8.5" transform="rotate(-22 24 24)" stroke="#1E5C3A" stroke-width="2" stroke-linecap="round" opacity="0.85" />
                            <circle cx="39" cy="18" r="2.5" fill="#FFD53D"/>
                            <path d="M 11 15 C 14 12.5, 34 12.5, 37 15 C 39 16.5, 37 17.5, 35 17 C 32 16, 16 16, 13 17 C 10 17.5, 9 16.5, 11 15 Z" fill="#D69200"/>
                            <path d="M 18 15 C 18.5 21, 18.5 27, 16.5 32.5 C 15.5 35, 12.5 35, 13 33 C 13.5 31.5, 15 30.5, 16 27.5 C 17 23, 17 18.5, 16 15 Z" fill="#D69200"/>
                            <path d="M 30 15 C 30 21, 30 27.5, 30 30.5 C 30 33.5, 32.5 35, 35 34 C 36.5 33.5, 36.5 31.5, 35 32 C 33.5 32.5, 32.5 31, 32.5 28 C 32.5 23.5, 32.5 18.5, 31.5 15 Z" fill="#D69200"/>
                            <path d="M 24 8 L 25.2 11.8 L 29 13 L 25.2 14.2 L 24 18 L 22.8 14.2 L 19 13 L 22.8 11.8 Z" fill="#FFD53D"/>
                        </svg>
                    </div>
                    <div>
                        <div class="header-logo-text">${SITE_CONFIG.name}</div>
            ...
            <div class="footer-grid">
                <div class="footer-brand">
                    <div class="footer-logo">
                        <div class="footer-logo-icon footer-logo-icon-mono">AM</div>
    ...
    function renderHomePage() {
        ...
        <section class="page-section" id="features-section">
            <div class="container text-center">
                <span class="section-badge"><span class="icon">✨</span> Why Mr. Ali Mahrous?</span>
                ...
                <div class="teacher-section-card reveal">
                    ...
                    <div class="teacher-content">
                        ...
                        <div style="display:flex;gap:12px;flex-wrap:wrap;">
                            ...
                            <a href="https://wa.me/201000000000" target="_blank" rel="noopener" class="btn btn-outline btn-lg">💬 Contact Mr. Ali</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div id="tab-overview" style="display:none;">
                    <div class="card card-flat" style="padding:var(--space-xl);">
                        ...
                        <ul style="display:grid;grid-template-columns:1fr 1fr;gap:10px;">
                            <li style="display:flex;align-items:center;gap:8px;font-size:0.92rem;">✅ Understand core mathematical concepts</li>
    ...
    function renderLicensePage(courseId) {
            ...
            <div class="container">
                ...
                <div class="license-course-header reveal" style="margin-bottom:var(--space-xl); background:var(--bg-surface); padding:28px 32px; border-radius:24px; border:1px solid var(--border); box-shadow:0 4px 24px rgba(0,0,0,0.04);">
                    <div class="license-course-meta">
                        ...
                        <div style="background:var(--bg-alt); padding:16px 20px; border-radius:14px; border-left:4px solid var(--primary-500, #1D63C4); margin-bottom:22px;">
                                ...
                                <div class="iq-prem-transfer-steps">
                                    <div class="iq-prem-step-row">
                                        ...
                                        <span class="iq-prem-vf-num"
                                              onclick="navigator.clipboard && navigator.clipboard.writeText('01060976964').then(function(){ showToast('Number copied', 'success'); })"
                                              title="Click to copy">📱 01060976964 <small>📋</small></span></span>
                                    </div>
                                    <div class="iq-prem-step-row">
        ...
        .iq-prem-act-header {
            ...
            gap: 16px;
            background: linear-gradient(135deg, var(--primary-500, #1D63C4) 0%, var(--primary-700, #113D7C) 100%);
            padding: 22px 28px;
            color: #fff;
        }
        .iq-prem-act-lock {
        ...
        .iq-prem-act-col--highlight {
            background: linear-gradient(160deg, rgba(29,99,196,0.05) 0%, rgba(22,78,158,0.02) 100%);
            border-left: 1px solid rgba(29,99,196,0.2);
        }
        .iq-prem-opt-header {
            display: flex;
            align-items: center;
        ...
        .iq-prem-code-input:focus {
            border-color: var(--primary-500, #1D63C4);
            box-shadow: 0 0 0 3px rgba(29,99,196,0.12);
        }
        .iq-prem-code-btn {
            background: linear-gradient(135deg, var(--primary-500, #1D63C4), var(--primary-600, #164E9E));
            color: #fff;
            border: none;
            border-radius: 12px;
            padding: 11px 20px;
        ...
        .iq-prem-code-btn:hover {
            ...
            box-shadow: 0 6px 18px rgba(29,99,196,0.35);
        }
        ...
        .iq-premium-badge {
            background: linear-gradient(135deg, #eab308, #f5b400, #d69200);
            color: #0f172a;
            font-size: 1.15rem;
            font-weight: 900;
            padding: 7px 24px;
            border-radius: 50px;
            box-shadow: 0 4px 20px rgba(245,180,0, 0.45);
        ...
        .iq-step-num {
            ...
            height: 38px;
            border-radius: 12px;
            background: linear-gradient(135deg, #1D63C4, #113D7C);
            color: #ffffff;
            display: flex;
            align-items: center;
            justify-content: center;
        ...
        .iq-enrolled-banner {
            background: linear-gradient(135deg, rgba(37,99,235, 0.15), rgba(5, 150, 105, 0.05));
                ...
                <div class="lesson-tab-pane" id="ltab-pane-overview" style="display:none;">
                    <div class="card card-flat" style="padding:24px;border-radius:18px;border:1px solid var(--border);background:var(--bg-surface);margin-bottom:20px;">
                        ...
                        <p style="color:var(--text-secondary);line-height:1.85;margin-bottom:20px;">
                            ${lesson.description || course.description || 'Comprehensive explanation and practical exercises with Mr. Ali Mahrous.'}
                        </p>
        ...
        <div class="quiz-preview-card" style="background:var(--bg-surface);padding:32px;border-radius:20px;border:1.5px solid var(--border);box-shadow:0 8px 30px rgba(0,0,0,0.05);text-align:center;">
            ...
            <div style="display:flex;justify-content:center;gap:24px;margin:20px 0;flex-wrap:wrap;">
                <div style="background:var(--bg-alt);padding:12px 20px;border-radius:12px;border:1px solid var(--border);">
                    <div style="font-size:1.3rem;font-weight:900;color:var(--primary-500, #1D63C4);">${qCount}</div>
    ...
    function renderTestPage(quizId, courseId, lessonId) {
        ...
        .test-timer-badge {
            background: #fff3c4; color: #855900; border: 1px solid #fee58a;
        ...
        .trm-pct     { background: #EAF2FC; color: #113D7C; }
            ...
            <div class="auth-visual">
                ...
                <div class="auth-visual-content">
                    <div class="auth-teacher-badge">
                        <div class="auth-t-img auth-t-img-mono" aria-hidden="true"><span>AM</span></div>
    ...
    function init() {
        ...
        const joinFamilyHTML =
            ...
            '  <div class="jf-inner">' +
            '    <span class="jf-badge">🤝 Our Community</span>' +
            '    <h2 class="jf-title">Join Our Family</h2>' +
            '    <p class="jf-subtitle">Follow Mr. Ali Mahrous and be part of a growing English learning family — lessons, updates and support, all in one place.</p>' +
            '    <div class="jf-card">' +
            '      <img src="join-family.png?v=20260913" alt="Mr. Ali Mahrous — English Language Teacher — Contact & Social Media" loading="lazy">' +
            '    </div>' +
            '  </div>' +
            '</section>';
        const layoutHTML =
    ...
    function renderAuthRequiredPage(courseId) {
        ...
        return '<div style="padding-top:calc(var(--header-height) + var(--space-3xl));padding-bottom:var(--space-3xl);min-height:80vh;display:flex;align-items:center;">' +
            ...
            '<div style="background:linear-gradient(135deg,#EAF2FC,#D3E6FA);border:1px solid #74AEEC;border-radius:14px;padding:16px 20px;margin-bottom:28px;">' +
            '<p style="margin:0;color:#113D7C;font-size:0.95rem;font-weight:600;">To access course: <span style="color:#0f172a;">' + courseTitle + '</span></p>' +
            '</div>' +
